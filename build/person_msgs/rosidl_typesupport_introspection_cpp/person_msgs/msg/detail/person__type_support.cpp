...
{
  new (message_memory) person_msgs::msg::Person(_init);
}

void Person_fini_function(void * message_memory)
{
  auto typed_message = static_cast<person_msgs::msg::Person *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Person_message_member_array[2] = {
  {
    ...
    offsetof(person_msgs::msg::Person, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(person_msgs::msg::Person, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::person_msgs::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, person_msgs, msg, Person)() {
  return &::person_msgs::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
