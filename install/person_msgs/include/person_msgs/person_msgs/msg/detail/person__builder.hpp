...
class Init_Person_distance
{
public:
  explicit Init_Person_distance(::person_msgs::msg::Person & msg)
  : msg_(msg)
  {}
  ::person_msgs::msg::Person distance(::person_msgs::msg::Person::_distance_type arg)
  {
...
public:
  ...
  {}
  Init_Person_distance name(::person_msgs::msg::Person::_name_type arg)
  {
    msg_.name = std::move(arg);
    return Init_Person_distance(msg_);
  }
